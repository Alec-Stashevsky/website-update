...
### Regularization
MTL introduces a regularizing inductive bias which mitigates overfitting and the model's ability to fit random noise, known as the [Rademacher complexity](@10.1007/3-540-44581-1_15.). Different features and labels have different noise distributions which can cancel each other out. Learning jointly reduces the influence of single-source noise creating a more generalized representation.
