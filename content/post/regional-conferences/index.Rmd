...
links:
 - name: "Code Supplement Repository"
   url: https://github.com/Alec-Stashevsky/GAP-climate-research/tree/master/code/Regional%20Analysis
   icon_pack: fab
   icon: github
image:
...
In this post, I reexamine the ways we navigate to large conferences from around the world and how the carbon emissions of such conferences can be mitigated while still preserving the important community-building that thrives at such events. I consider the carbon footprint of holding a large conference through multiple, smaller meetings compared to holding one large centrally-located meeting. I call this framework a *regional format* for conferences throughout this post.
...
My point here is that the *carbon footprint* (which we have yet to define) is not a holistic measure of environmental friendliness/harm and it is misleading and potentially damaging to use the carbon footprint as a gauge for how harmful something is. The most damaging human-induced events like oil spills or nuclear meltdowns have carbon footprints far outmeasured by the loss of wildlife and habitat.

### History of the Carbon Footprint

Though I use the term *carbon footprint* throughout this post, I want to acknowledge the (not so pretty) history behind the term. *Carbon footprint* grew out of a related concept---the *ecological footprint*---invented in the 1990s by an ecologist William Rees and a regional planner Mathis Wackernagel.^[Selin, N. Eckley. *Carbon footprint. Encyclopedia Britannica.* https://www.britannica.com/science/carbon-footprint.]

However it was not until the early 2000s that the term was popularized by oil giant BP. In 2004, BP unveiled the first "carbon footprint calculator" which provided individuals with a way to quantify how much heat-trapping carbon pollution they were releasing into the atmosphere. Unfortunately, it provided users with no way of measuring the carbon footprint of drilling deep into the Earth to extract fossil fuels and occasionally dumping thousands of gallons of toxic fuel into the ocean.

Shifting the discourse of pollution onto the individual has long been a tactic of the largest corporate polluters. Even before we thought to worry about carbon pollution, we had marketing campaigns touting the righteousness of voluntary action. Recycling, bottle bills, and littering. In what appears to be the longest ad any millennial has ever seen, the famous "Crying Indian" first aired in 1971 on Earth day with the line: "People start pollution. People can stop it." Little did they know corporations would become people anyways.^[_See_ https://www.brennancenter.org/our-work/research-reports/citizens-united-explained]
...
To understand what the *carbon footprint* attempts to measure, we first need to understand how gaseous emissions capture heat.

Certain gases like carbon dioxide, methane, water vapor, methane, and ozone (O<sub>3</sub>) have molecular structures that absorb heat. These gases are transparent to the human eye (visible light), but *opaque* to longer wavelengths on the electromagnetic spectrum like infrared radiation. When energy from the sun enters Earth's atmosphere some of the heat is absorbed by these gas molecules causing them to vibrate more. Gas molecules which absorb heat in this manner are referred to as *Greenhouse Gases* (GHGs) because they cause the Earth's atmosphere to capture and reemit heat much like the windows in a greenhouse. This process is pictured below.

![](/images/regional-conferences/GHG-diagram.jpg)

As energy from the sun enters the Earth's atmosphere and is reflected by the Earth's surface, some of it becomes trapped by GHGs. GHGs naturally occur in Earth's atmosphere but the burning of fossil fuels and other chemicals have and continue to rapidly increase the level of GHGs thus trapping more and more heat and contributing to global warming and climate change. This is essentially thickening the windows and increasing the insulation of the greenhouse.

However, GHGs are not all the same. Some are better at absorbing heat than others, and some last longer in the atmosphere before breaking down.^[_See_ @brander2012greenhouse.]
We can gauge the warming abilities of different GHGs by measuring how much additional warming they cause compared to carbon dioxide over a given time period, generally 100 years. This measurement is referred to as the *global warming potential* (GWP) of a GHG. The table below illustrates common GHGs and their corresponding GWP. Data are from the Intergovernmental Panel on Climate Change (IPPC) [2014 Fifth Assessment Report](https://www.ipcc.ch/report/ar5/syr/).
...
Here we can see that releasing one kilogram of methane gas into the atmosphere is 25 times better at trapping heat than releasing the same amount of carbon dioxide. Sulfur hexafluoride, a gas used mainly by the energy industry as an insulator and spark-suppressant in power transmission and distribution systems all over the world, is 23,500 times better at trapping heat than the equivalent amount of carbon dioxide.^[Additionally, during its working cycle, sulfur hexafluoride decomposes under electrical stress, forming toxic byproducts which pose a health threat for workers in the event of exposure. _See_ @SulfurHexafluoride.]
...
However, to produce a better measure we can instead describe all GHGs under a common unit called *carbon dioxide equivalents* (CO<sub>2</sub>*e*) which captures the total impact to global warming from all different GHGs in terms of the amount of carbon dioxide it would take to have an equivalent impact on global warming from all GHGs. This is a more accurate way of measuring the *carbon footprint* of a process because it is more comprehensive.
...
It is important to be careful in the ways we which we characterize our understanding of processes which contribute to global warming so that we authentically and holistically capture what we can measure and acknowledge what we cannot. Its best to be explicit and avoid terms like carbon emissions. In what follows, I return to the analysis of regional conferences and will do my best to avoid further conflating terminology.
