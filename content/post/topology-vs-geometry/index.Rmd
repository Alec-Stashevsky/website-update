...
However, the Latitude and Longitude coordinate system is part of a fundamentally different type of geometry: a non-euclidean one native to the 3-dimensional ellipsoidal shape of the Earth (link). We can convert this non-euclidean space to a 2-d euclidean space in the traditional Cartesian coordinate system by using the [Universal Transverse Mercator (UTM)](https://openpress.usask.ca/introgeomatics/chapter/cartesianprojected-coordinate-systems-utm/) map projection.^[Map projections are not perfect, and some distortion will occur depending on the reference point of the mapping.] The UTM projection gives us an $(easting, \ northing)$ point in for each point in $(latitude, \ longitude)$ space. 
...
Machine learning canon evolved using euclidean data and enforced this regular topology implicitly. The invariances of the regular grid-structure were built into the models.^[*See* @DBLP:journals/corr/BronsteinBLSV16.] As an artifact, much of machine learning has bound models to specific data with strict limitations on input structure. [Geometric Deep Learning](https://flawnsontong.medium.com/what-is-geometric-deep-learning-b2adb662d91d) is carving a different paradigm in which models are designed to understand and exploit the topological and geometric properties of their inputs. Models designed through this paradigm can adapt to different and more complex topology induced by graphs, [symmetry groups](https://www.cantorsparadise.com/an-invitation-to-group-theory-c81e21ab739a), and [manifolds](https://bjlkeng.github.io/posts/manifolds/) with dynamically-sized inputs.^[*See* @NIPS2014_f9be311e for treatment of symmetry groups and @NIPS2017_0ebcc77d for treatment of manifolds.]
