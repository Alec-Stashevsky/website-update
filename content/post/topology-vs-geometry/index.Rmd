...
For machines to learn on data, be it graph-structured or not, we must represent it in a way computers can digest. That is to say, we must encode the data into some *n*-dimensional Euclidean vector space where individual data points are vectors within that space.
...
<!-- In document AI, there has been recent application of graphs, which attempt to use them to uncover a *semantic* topology. ## Teaching Machines to Comprehend Documents -->
