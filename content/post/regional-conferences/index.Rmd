...
For the most part the total number of attendees at each regional meeting is around 1.5 to 3 thousand, with the exception of Region 2 on the left panel (2018 Data). This is a good indication that the regional designations assigned by the APA and our assumptions about international attendees break the membership base into somewhat even parts. If we consider this column plot along with the regional flight network map depicted above, we can see the New York city meeting receives the majority of international attendees whom are largely from Europe. When we use the 2019 Data the attendance is much more even.

### Bias in Attendance Data

I won't go into all the implications of why the 2018 and 2019 attendance data sets may be different, but I want to address some inherent biases in the data. Because these data were collected based on the actual attendance of the 2018 and 2019 APA Annual Meetings, we need to consider how this may affect our analysis, specifically our ability to compare between meetings or predict who will attend what meetings.

Generally, the farther away a conference is, the less likely one is to attend. Traveling farther away is more costly, more time consuming, and it is much easier to drive directly rather than fly if its reasonable. Together these factors influence the range of people who attend each meeting. I call this phenomenon *geographic bias.*

Such bias is present is likely present in the APA attendance data. The 2018 New York City meeting data shows a smaller proportion of members from the West Coast even though approximately three thousand more people attended the meeting compared to the 2019 San Francisco one. Similarly, the proportion of attendees from the West Coast increased the the following year at the 2019 meeting.
...
In this sense, the analysis would surely benefit from a broader set of attendance data. Data which includes a geographically-diverse set of of conferences. This way, it would be possible to tease out the different sections of the APA's membership that *would have come* if the meeting was closer to them.^[We performed a benchmarking analysis on the two data sets by measuring the relative increase in attendance within a 400 km radius of the meeting.]

## Regial Simulation Resuts

Following @10.1001/jamanetworkopen.2020.35641, I estimate total emissions of for the conferences under the regional conference format. The table below presents the results for the 2018 New York City and 2019 San Francisco simulations, respectively. The carbon footprint of the attendees' commute to the meetings is measured by the emission of greenhouse gases (GHGs) as metric tons of carbon-dioxide equivalents (CO<sub>2</sub>*e*).
...
* We can see the emissions is lower for the regions by XYZ.
* Why is the reduction for SF so much larger? 
  * Explain optimality for NYC based on APA attendance base
